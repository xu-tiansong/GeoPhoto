...
const translations = {
    en: {
        ...
        'photo.contextMenu.delete':  'Delete Photo',
        'photo.contextMenu.tags':          'Tags',
        'photo.contextMenu.addTag':        'Add Tag',
        'photo.contextMenu.removeTagPrefix': 'Remove: ',
        'photo.deleteConfirmTitle':  'Delete Photo',
        'photo.deleteConfirmMsg':    'Are you sure you want to permanently delete this photo? This action cannot be undone.',
        'photo.deleteConfirmOk':     'Delete',
    ...
    zh: {
        ...
        'photo.contextMenu.delete':  '删除照片',
        'photo.contextMenu.tags':          '标签',
        'photo.contextMenu.addTag':        '添加标签',
        'photo.contextMenu.removeTagPrefix': '移除：',
        'photo.deleteConfirmTitle':  '删除照片',
        'photo.deleteConfirmMsg':    '确定要永久删除这张照片吗？此操作无法撤销。',
        'photo.deleteConfirmOk':     '删除',
